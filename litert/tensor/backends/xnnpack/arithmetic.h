...
template <>
class OpMixin<LeakyReluOperation, XnnpackMixinTag>
...
template <>
class OpMixin<HardSwishOperation, XnnpackMixinTag>
    : public XnnpackOperation {
 public:
  absl::Status ToXnnpack(const graph::Operation& op,
                         XnnpackBuildContext& ctx) const override;
...
template <>
class OpMixin<MaxPool2DOperation, XnnpackMixinTag>
    : public XnnpackOperation {
 public:
  absl::Status ToXnnpack(const graph::Operation& op,
                         XnnpackBuildContext& ctx) const override;
...
template <>
class OpMixin<BatchMatMulOperation, XnnpackMixinTag>
    : public XnnpackOperation {
 public:
  absl::Status ToXnnpack(const graph::Operation& op,
                         XnnpackBuildContext& ctx) const override;
...
template <>
class OpMixin<TransposeOperation, XnnpackMixinTag>
    : public XnnpackOperation {
 public:
  absl::Status ToXnnpack(const graph::Operation& op,
                         XnnpackBuildContext& ctx) const override;
...
template <>
class OpMixin<ExpandDimsOperation, XnnpackMixinTag>
    : public XnnpackOperation {
 public:
  absl::Status ToXnnpack(const graph::Operation& op,
                         XnnpackBuildContext& ctx) const override;
